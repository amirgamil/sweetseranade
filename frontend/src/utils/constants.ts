...
export const loadingTextOptions = [
    "Generating a love song...",
    "Downloading more sappiness... 0% complete",
    "Assembling the love song puzzle piece by piece... one moment please",
    "Sifting through countless love ballads... just for you",
    "Compiling all the cheesiest love lyrics... almost there",
    "Preparing the ultimate love anthem... brace yourself for the sap",
    "Making sure the song is just the right amount of corny... loading",
    "Love takes time, patience....",
];
